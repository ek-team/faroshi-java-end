...
public interface UserOrderMapper extends BaseMapper<UserOrder> {
    ...
    @Select("SELECT user_order.wms_order,user_order.transaction_id,user_order.bill_image,user_order.bill_type,user_order.settlement_amount,user_order.review_refund_order_id,user_order.pay_type,user_order.test,user_order.sale_spec_recovery_price,user_order.sale_spec_service_end_time,user_order.refund_review_time,user_order.refund_initiation_time,user_order.acceptance_time,user_order.recycle_time,user_order.move_time,user_order.logistics_delivery_time,user_order.product_sn3,user_order.product_sn2,user_order.product_sn1,user_order.actual_retrieve_amount,user_order.use_day,user_order.id,user_order.bill_id,user_order.product_pic,user_order.delivery_time,user_order.pay_time,hospital_info.name as  hospitalName,user_order.delivery_date,user_order.order_no,doctor_team.name as doctorTeamName, " +
    ...
    @Select("SELECT user_order.transaction_id,user_order.product_sn3,user_order.product_sn2,user_order.product_sn1,user_order.actual_retrieve_amount,user_order.use_day,user_order.id,user_order.bill_id,user_order.product_pic,user_order.delivery_time,user_order.pay_time,hospital_info.name as  hospitalName,user_order.bill_image,user_order.delivery_date,user_order.order_no,doctor_team.name as doctorTeamName, " +
            "user_order.dept_id,user_order.receiver_phone,user_order.receiver_name,user_order.receiver_detail_address," +
            "user_order.status,user_order.create_time,user_order.remark," +
            "user_order.payment,user_order.sale_spec_id,user_order.product_spec," +
            "user_order.service_pack_id,user_order.user_id,patient_user.name as patientUserName,patient_user.id_card as patientUserIdCard " +
