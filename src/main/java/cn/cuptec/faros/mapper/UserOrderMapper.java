...
public interface UserOrderMapper extends BaseMapper<UserOrder> {
    ...
    @Select("SELECT user_order.id,user_order.bill_image,user_order.bill_id,user_order.product_pic,user_order.receiver_detail_address,user_order.order_no,user_order.order_type, " +
            "user_order.user_id," +
            "user_order.dept_id," +
