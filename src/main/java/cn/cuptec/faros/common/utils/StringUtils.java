...
public class StringUtils extends org.apache.commons.lang3.StringUtils
{
     ...
     * @return
     */
    public static List<String> getBracedStr(String origionalStr, boolean removeBrace) {
        String p1="\\{[^\\{\\}]{1,}\\}"; //匹配大括号
        Pattern p=Pattern.compile(p1);
        Matcher m=p.matcher(origionalStr);
...
//        List<String> bracedStr = getBracedStr("今天天{(3)}气不错，阳光挺{(10)}好的····',如何能把'{(3)},{(10)}........$FD........{12}", false);
//        for (String str :
//                bracedStr) {
...
//    }
     ...
     * @return
     */
    public static boolean isStartWithChinese(char c) {
     ...
     * @return
     */
    public static boolean isStartWithEnglish(String charaString){
        charaString = charaString.substring(0,1);
        return charaString.matches("^[a-zA-Z]*");
    }
     ...
     * 这样重复率大大降低。
     * @param len 指定的位数，必须大于等于8
     * @return
     */
    public static String generateShortUuid(int len) {
        if(len < 8)
            throw new IllegalArgumentException("指定的位数必须不小于8");
