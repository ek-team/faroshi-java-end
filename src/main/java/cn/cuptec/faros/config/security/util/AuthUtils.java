...
public class AuthUtils {
	...
	private final String SOCIAL_AUTH_PREFIX = "SOCIAL@";
     ...
     * @return
     */
	public String getWxAuthParameter(String preAuthKey, int userId){
	    return SOCIAL_AUTH_PREFIX + preAuthKey + StringPool.COLON + userId;
    }
